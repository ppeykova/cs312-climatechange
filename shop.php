    ...
    for ($j=0; $j < count($array); $j = $j + 3) {
        ...
        for($c=0; $c < 3; $c++) {
            if(!empty($array[$j + $c])) {
                ...
                echo "<br><td><img src='data:image/jpeg;base64," . base64_encode($image) . "'/>" . "</br> $description </br> £ $price </br> <form method='post'><button name='add'> Add to basket </button></form></td>\n";
            }
        }
        echo "</tr>\n";
    }
